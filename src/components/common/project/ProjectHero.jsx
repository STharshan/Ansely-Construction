...
export default function ProjectHero({ hero }) {
  return (
    <section className="bg-[var(--color-panel)] px-5 pb-6 pt-16 text-[var(--color-ink)] sm:px-8 lg:px-20 lg:pb-8 lg:pt-32">
      <div className="mx-auto max-w-[1680px]">
        <ProjectReveal className="max-w-[60rem]">
          ...
          <p className="mt-6 max-w-[42rem] text-[18px] leading-7 text-[var(--color-ink-muted)] sm:text-[18px]">
            {hero.description}
          </p>
        </ProjectReveal>
      </div>
