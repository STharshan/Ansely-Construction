...
export default function AboutGallery() {
  return (
    <section className="bg-white px-4 py-10 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-[1360px]">
        <div className="grid gap-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-12 xl:grid-cols-[320px_minmax(0,1fr)]">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="max-w-[840px] text-[2.25rem] mb-12 md:mb-0 font-semibold uppercase leading-[0.96] tracking-[-0.06em] text-[#111111] sm:text-[3.3rem]">
