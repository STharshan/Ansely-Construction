...
export default function HeroSection() {
  return (
    <section className="bg-[var(--color-surface)] px-3 pb-0 pt-3 font-['DM_Sans',_sans-serif] sm:px-4 sm:pt-4">
      <div className="relative overflow-hidden rounded-[26px] bg-[var(--color-ink)] pb-15 text-white sm:rounded-[30px]">
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat"
          style={{ backgroundImage: `url(${heroImage})` }}
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.58)_0%,rgba(0,0,0,0.38)_25%,rgba(0,0,0,0.62)_62%,rgba(0,0,0,0.82)_100%)]" />
        ...
        <div className="relative z-20 mx-auto flex min-h-[640px] max-w-7xl flex-col justify-end px-4 pb-6 pt-28 sm:px-6 sm:pb-8 md:min-h-[620px] md:px-8 lg:px-8 lg:pb-4 lg:pt-32">
          <div className="grid items-end gap-8 lg:grid-cols-[minmax(0,1fr)_460px] xl:grid-cols-[minmax(0,1fr)_500px]">
            <div className="max-w-[760px] pb-3 md:pb-6 lg:pb-7">
              <div className="mt-5 inline-flex rounded-full border border-white/10 bg-[color:rgba(156,156,85,0.62)] px-5 py-1 text-sm font-medium tracking-tight text-white shadow-[0_12px_30px_rgba(0,0,0,0.18)] backdrop-blur-md sm:mt-0">
                <span className="mr-3 mt-[5px] h-2 w-2 rounded-full bg-[var(--color-brand)]" />
              ...
              <p className="mt-6 max-w-[910px] text-base font-normal leading-relaxed text-white/90 sm:text-lg lg:max-w-[790px] lg:text-[1.1rem]">
            ...
            <div className="w-full lg:mb-[14px] lg:justify-self-end">
              <div className="rounded-[28px] border border-white/10 bg-[color:rgba(0,0,0,0.62)] p-4 shadow-[0_24px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:p-5">
                <div className="flex flex-col gap-5 sm:flex-row">
                  ...
                  <div className="flex flex-1 flex-col justify-between gap-4 pt-1">
                    ...
                    <div className="border-t border-white/10 pt-6">
                      <a
                        href="#contact"
                        className="group inline-flex items-center gap-3 text-[1.05rem] font-semibold text-white transition hover:text-[var(--color-brand-soft)]"
                      >
                        Start Your Build
                        <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--color-brand)] text-[var(--color-ink)] transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5">
