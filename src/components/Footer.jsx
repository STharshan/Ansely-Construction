...
// Map the names to the actual paths defined in your App routes
const footerLinks = [
  { name: "Home", path: "/" },
          ...
          <div className="mt-12 border-t border-white/10 pt-12 lg:mt-[52px] lg:pt-[54px]">
            <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-[1.2fr_1.1fr_1fr_1.3fr] xl:gap-0">
              ...
              <div className="xl:px-7">
                <h3 className="text-[1.05rem] font-semibold text-white">Address:</h3>
              ...
              <div className="xl:border-l xl:border-white/10 xl:px-4">
                <h3 className="text-[1.05rem] font-semibold text-white">Get in Touch:</h3>
              ...
              <div className="xl:border-l xl:border-white/10 xl:pl-7">
                <h3 className="text-[1.05rem] font-semibold text-white">Subscribe Newsletter&apos;s:</h3>
